                ...
                <Tab activeTab={1}>
                    <Tab.Panel>
                        ...
                        <div>
                            ...
                            <span className={style.hide}> Dashboard </span>
                        </div>
                    </Tab.Panel>
                    <Tab.Panel>
                        {" "}
                    ...
                    <Tab.Panel>
                        <div>
                            <img src={modules}></img>
                            <span className={style.hide}>Modules </span>
                        </div>
                    </Tab.Panel>
                    <Tab.Panel>
                        {" "}
                        <div>
                            <img src={sprint}></img>
                            <span className={style.hide}>Sprint </span>
                        </div>
                    </Tab.Panel>
                    <Tab.Panel>
                        <div>
                            <img src={members}></img>
                            <span className={style.hide}>Members </span>
                        </div>
                    </Tab.Panel>
                    <Tab.Panel>
                        {" "}
                        <div>
                            <img src={report}></img>
                            <span className={style.hide}>Reports </span>
                        </div>
                    </Tab.Panel>
                </Tab>
            </div>
